...
- [A tour of mixMVPLN With Parameter Estimation via MCMC-EM](https://github.com/anjalisilva/mixMVPLN/blob/master/vignettes/Introduction_mixMVPLN_MCMEM.md)

- [A tour of mixMVPLN With Parameter Estimation via VGA](https://github.com/anjalisilva/mixMVPLN/blob/master/vignettes/Introduction_mixMVPLN_MCMEM.md)

- [A tour of mixMVPLN With Parameter Estimation via Hybrid Approach](https://github.com/anjalisilva/mixMVPLN/blob/master/vignettes/Introduction_mixMVPLN_MCMEM.md)
