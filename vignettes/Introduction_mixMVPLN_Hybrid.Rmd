---
title: "A Tour of mixMVPLN: Parameter Estimation via Hybrid Appraoch"
author: "Anjali Silva"
...
vignette: >
  %\VignetteIndexEntry{A Tour of mixMVPLN: Parameter Estimation via Hybrid Appraoch}
...
### Parameter Estimation via Hybrid Approach
...
## Clustering
<div style="text-align:left">
Once the count data is available, clustering can be performed using the *mixMVPLN::mvplnHybriDclus* function. See *?mvplnHybriDclus* for more information, including examples and references. Here, clustering will be performed using the above generated dataset. 

Below, clustering of *simulatedMVData$dataset* is performed for g = 1:2 with 300 iterations and *random* initialization with 2 initialization runs. 
...
The above plot illustrates, for each observation, the probability of belonging to component/cluster 1 (P1) or probability of belonging to component/cluster 2 (P2). In this example, there were 50 observations in the dataset. The bar for each observation look monotone, indicating high confidence in belonging to the indicated component/cluster. 
